...
write.csv2(t(samples$reads), 
           file = file.path(lib_dir, "csv_files", "dryver-euka02-samples_reads.csv"))
write.csv2(samples$pcrs[, !colnames(samples$pcrs) %in% c("control_type", "type", "sample_id")], 
           file = file.path(lib_dir, "csv_files", "dryver-euka02-samples_pcrs.csv"))
write.csv2(samples$motus[, !(colnames(samples$motus) %in% c("definition", "x", 
           ...
           file = file.path(lib_dir, "csv_files", "dryver-euka02-samples_motus.csv"))
write.csv2(samples$samples, file = file.path(lib_dir, "csv_files", "dryver-euka02-samples_samples.csv"))

clust_mtbl <- readRDS(clust_rds_file)
...
write.csv2(t(clust_samples$reads), file = file.path(lib_dir, "csv_files", "dryver-euka02-clust_samples.csv"))
write.csv2(clust_samples$motus[, !(colnames(clust_samples$motus) %in% c("definition", "x", 
           ...
           file = file.path(lib_dir, "csv_files", "dryver-euka02-clust_samples_motus.csv"))
...
saveRDS(clust_rds, file = file.path(lib_dir, "rds_files", "dryver-euka02-clust_motus_samples.rds"))
...
final_mtbl$motus <- final_mtbl$motus[, !(colnames(samples$motus) %in% c("definition", "x") | 
                                           ...
                                           grepl("control_abundance", colnames(samples$motus)) |
                                           grepl("sequencing_control", colnames(samples$motus)))]
saveRDS(final_mtbl, file = file.path(lib_dir, "rds_files", "dryver-euka02-result-samples-metabarlist.rds"))
